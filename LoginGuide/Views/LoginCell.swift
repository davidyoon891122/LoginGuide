...
//  LoginGuide
//
//  Created by David Yoon on 2021/07/29.
//
...
class LoginCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        _ = emailTextField.anchor(logoImageView.bottomAnchor, left: leftAnchor, bottom: nil, right: rightAnchor, topConstant: 50, leftConstant: 32, bottomConstant: 0, rightConstant: 32, widthConstant: 0, heightConstant: 50)
